...
const create = async (name, description, images, sub_category_id, main_category_id) => {
    const item = await new itemModel({name: name, description: description, sub_category_id, main_category_id});
